package com.quantumsoft.fourk.max.giraffeplayer;
...
//        subtitles = (TextView) activity.findViewById(R.id.txtSubtitles);
    ...
    private void hideAll() {
        play.play_activity.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        $.id(R.id.app_video_replay).gone();
