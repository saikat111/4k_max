package com.quantumsoft.fourk.max.fragment;
...
public class ol_search_adepter extends RecyclerView.Adapter<ol_search_adepter.MyViewHolder> {
    ...
    public ol_search_adepter(final Activity mContext, ArrayList<search_video_list> category_list) {
    ...
    @Override
    public ol_search_adepter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_list_layout, parent, false);

        return new ol_search_adepter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ol_search_adepter.MyViewHolder holder, int position) {
