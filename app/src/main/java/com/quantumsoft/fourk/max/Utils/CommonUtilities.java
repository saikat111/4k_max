package com.quantumsoft.fourk.max.Utils;
...
import com.quantumsoft.fourk.max.model.folder_l;
...
public class CommonUtilities {
    ...
    public static ArrayList<video_l> FinalVideoList;
    ...
    public static ArrayList<folder_l> getmediaperent(ArrayList<String> folder_list_t, ArrayList<folder_l> folder_list) {
        for (int i = 0; i < folder_list_t.size(); i++) {
            ...
            if (folder_list != null) {
                if (folder_list.size() > 0) {
                    ...
                    if (!isFolderFound) {
                        folder_l a = new folder_l(f.getParent(), 1);
                        folder_list.add(a);
                    }
                } else {
                    File f = new File(folder_list_t.get(i));
                    folder_list.add(new folder_l(f.getParent(), 1));
                }
            }
        }
